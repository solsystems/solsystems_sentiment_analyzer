...
// Initialize chart on DOM content loaded (for initial page load)
document.addEventListener('DOMContentLoaded', initializeChart);

// Initialize chart on Turbo navigation (for SPA-like navigation)
document.addEventListener('turbo:load', initializeChart);

// Clean up chart on Turbo navigation start
